...
여기서 끝이 아니었다. 디자인 시안이 변경된다는 것을 알게 된 시점에서 모든 종류를 쉽게 확인할 수 있는 방법이 있다면 좋겠다고 생각했습니다.
...
결론적으로는 일의 "효율성"이 늘어나게 됩니다. 간단하게 연동 과정을 설명하고 넘어가겠다.
...
대 스토리북은 잘못 없고 일단 내 잘못이다 생각하고 내 실수를 찾아보기 시작했습니다.
