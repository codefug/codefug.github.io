...
![](Pasted%20image%2020240721171036.png)
...
![](Pasted%20image%2020240721171054.png)
...
## axios interceptor
![](Pasted%20image%2020240721171000.png)
```tsx
// 요청 인터셉터 추가하기
...
![](Pasted%20image%2020240721173745.png)

refreshToken은 쿠키에 잘 있는 것을 확인할 수 있다.

![](Pasted%20image%2020240721173806.png)

accessToken이 만료되면 network 탭에 다음과 같이 표시된다.

![](Pasted%20image%2020240721174651.png)
